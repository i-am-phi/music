...
/**
 * Class PhotonChordsPlugin
 * @package Grav\Plugin
 */
class PhotonChordsPlugin extends Plugin
{
    ...
    public function onTwigSiteVariables()
    {
      ...
      if ($page->template() == 'chords')
      {

        // styles
        if ($this->config->get('plugins.photon-chords.built_in_css')) {
          $css = 'plugin://photon-chords/assets/chords.css';
          $assets->addCss($css, 100, false, 'photon-plugins' );
        }

        // scripts
        if ($this->config->get('plugins.photon-chords.built_in_js')) {
          $js = 'plugin://photon-chords/assets/chords.js';
